...
<p class="mt-2 text-gray-800 dark:text-gray-200">请使用wps将excel的前4列，列名分别设置为name，dis，site，mid，对应的列内容为网站名字，网站描述，网站地址，分类mid，其中网站描述列内容可以为空，然后导出csv，最后将csv在这里上传即可！【注意：批量导入不会检查重复项，建议导入前使用excel去重】</p>
