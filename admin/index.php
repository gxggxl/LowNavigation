...
<div class="p-2 w-full">
    <a :href="item.site" class="h-full bg-white dark:bg-gray-900 flex items-center border-gray-100 dark:border-gray-600 border p-3 rounded hover:shadow-md duration-300" target="_blank" x-data="{icon:item.icon}" x-init="if(!icon){icon='https://zezeshe.com/api/ico/?url='+item.site;}">
